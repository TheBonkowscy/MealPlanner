...
namespace MealPlanner.Persistence.Migrations
{
    ...
    [Migration("20260826181136_AddedRecipePreparations")]
    partial class AddedRecipePreparations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "measure_unit", new[] { "glass_cup", "tablespoon", "teaspoon", "milligram", "gram", "kilogram", "milliliter", "liter", "piece", "package", "can", "bottle", "pinch", "slice1", "slice2" });
            ...
            modelBuilder.Entity("MealPlanner.Domain.Ingredients.UsedIngredient", b =>
                {
                    ...
                    b.ToTable("UsedIngredients", (string)null);
                });
            ...
            modelBuilder.Entity("MealPlanner.Domain.Menus.Menu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MealPlanner.Domain.Menus.Meal", b =>
                {
                    b.HasOne("MealPlanner.Domain.Menus.Menu", "Menu")
                        .WithMany("Meals")
